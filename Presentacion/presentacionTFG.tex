...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{\textbf{ULL-AR}}
\subtitle{Tecnología de RA en entornos universitarios}
\author[Alejandro Hernández Padrón]
{
...
\defbeamertemplate*{title page}{AGH}[1][]
{
  \vbox{}
  %\vspace*{2.3cm}
  \vfill \includegraphics[width=0.3\linewidth]{Images/marca-universidad-de-la-laguna-original}
    \vfill
  %\hspace*{1.8cm}
  % \begin{columns}
...
\begin{document}
	...
	\frame{\frametitle{Índice}\tableofcontents}
		...
		\section{RA en entornos universitarios}
