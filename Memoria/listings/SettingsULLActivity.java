...
public class SettingsULLActivity extends AppCompatPreferenceActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        switch (key){
            case SHOW_RADIUS_STRING: //Activamos o desactivamos la edicion radios de forma manual
                ...
                break;
            case MAX_RADIUS_STRING: //Actualizamos el valor de la vista de maxRadius
                ....
            case MIN_RADIUS_STRING://Actualizamos el valor de minRadius y comprobamos si es mayor 
                ...                   //que maxRadius 
        }
    }
    ...
