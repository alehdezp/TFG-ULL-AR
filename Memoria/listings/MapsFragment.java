public class MapsFragment extends Fragment implements OnMapReadyCallback ...{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container ...) {
        View rootView = inflater.inflate(R.layout.fragment_maps...); // Creamos la vista principal
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        actualPosMarker = goMap.addMarker(new MarkerOptions()..)); // Marcador en la ubicacion GPS
    ...
    private void redrawCircles(LatLng position) {...} // Se actualizan los centros de los circulos
