public class HomeFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        homeLayoutManager = new LinearLayoutManager(getContext()); //Asiganamos un LinearLayout
        //Construimos el objeto ItemHomeAdapter
        ...
        new ItemHomeAdapter.OnItemClickListener(){ 
            ...
            public void onItemClick(ItemHome item, int position){
                    switch (position) {
                        case 0: 
                        ... //Lanzamos los activitys y fragments correspondientes
