...
su labor como tutor de este proyecto y orientando este trabajo. XXX
\end{large}
...
\begin{palabrasClave}
Aplicaciones Android, Java, dispositivos móviles, programación, Realidad Aumentada . . . . XXX
\end{palabrasClave}
...
MI RESUMEN en Inglés

\bigskip
Para hacer un espaciado grande XXX
}

\begin{keywords}
Application for Android, Java, mobile devices, programming, Augmented Reality ... XXX
\end{keywords}
...
% ha puesto.
\markboth{Alejandro Hernández Padrón}{ULLNavigation}
