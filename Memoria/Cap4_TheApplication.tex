...
En este capítulo se explicará la aplicación \ULLAR{} utilizando la especificación de requisitos de esta y explicando su funcionamiento.
...
Para poder utilizar \ULLAR{}, el usuario ha de poseer una cuenta de correo institucional de la ULL. Este correo ha de terminar con el formato: ``\textit{@ull.edu.es}''. Sin ella no se podrá acceder a la aplicación. Además, se podrá cerrar la sesión de esta cuenta.
